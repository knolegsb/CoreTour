...
{
    public class CoreTourDbSeedData
    {
        private CoreTourDbContext _context;
        private UserManager<CoreTourUser> _userManager;

        public CoreTourDbSeedData(CoreTourDbContext context, UserManager<CoreTourUser> userManager)
        {
            _context = context;
        ...
        {
            if (await _userManager.FindByEmailAsync("kimberly.kim@coretour.com") == null)
            {
                var user = new CoreTourUser()
                {
                    UserName = "kimberlykim",
                    Email = "kimberlykim@coretour.com"
                };
